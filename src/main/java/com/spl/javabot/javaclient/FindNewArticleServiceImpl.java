...
public class FindNewArticleServiceImpl implements FindNewArticleService {
    ...
    public static final String JAVA_WEB_POST_FORMAT = "https://javarush.com/groups/posts/%s";

    private final GroupSubService groupSubService;
    private final JavaPostClient javaRushPostClient;
    private final SendBotMessageService sendMessageService;

    @Autowired
    public FindNewArticleServiceImpl(GroupSubService groupSubService,
                                     JavaPostClient javaRushPostClient,
    ...
    private String getPostUrl(String key) {
        return String.format(JAVA_WEB_POST_FORMAT, key);
    }
}
